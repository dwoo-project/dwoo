...
class PluginTypesTests extends PHPUnit_Framework_TestCase
{
    ...
    {
        $tpl = new Dwoo\Template\String('{CompilableFunctionPlugin 4 5}');
    ...
    {
        $tpl = new Dwoo\Template\String('{$foo=4}{$foo|CompilableFunctionPlugin:5}');
        $tpl->forceCompilation();
    ...
    {
        $tpl = new Dwoo\Template\String('{FunctionPlugin 4 5}');
        $tpl->forceCompilation();
    ...
    {
        $tpl = new Dwoo\Template\String('{$foo=4}{$foo|FunctionPlugin:5}');
        $tpl->forceCompilation();
    ...
    {
        $tpl = new Dwoo\Template\String('{CompilableClassPlugin 4 5}');
        $tpl->forceCompilation();
    ...
    {
        $tpl = new Dwoo\Template\String('{$foo=4}{$foo|CompilableClassPlugin:5}');
        $tpl->forceCompilation();
    ...
    {
        $tpl = new Dwoo\Template\String('{ClassPlugin 4 5}');
        $tpl->forceCompilation();
    ...
    {
        $tpl = new Dwoo\Template\String('{$foo=4}{$foo|ClassPlugin:5}');
        $tpl->forceCompilation();
    ...
    public function testCustomCompilableFunctionPlugin()
    {
        ...
        $tpl = new Dwoo\Template\String('{CustomCompilableFunctionPlugin 4 5}');
        $tpl->forceCompilation();
    ...
    public function testCustomCompilableFunctionPluginAsModifier()
    {
        $dwoo = new Dwoo\Core(DWOO_COMPILE_DIR, DWOO_CACHE_DIR);
        $dwoo->addPlugin('CustomCompilableFunctionPlugin', 'custom_compilable_plugin', true);
        $tpl = new Dwoo\Template\String('{$foo=4}{$foo|CustomCompilableFunctionPlugin:5}');
        $tpl->forceCompilation();
    ...
    public function testCustomFunctionPlugin()
    {
        ...
        $tpl = new Dwoo\Template\String('{CustomFunctionPlugin 4 5}');
        $tpl->forceCompilation();
    ...
    public function testCustomFunctionPluginAsModifier()
    {
        $dwoo = new Dwoo\Core(DWOO_COMPILE_DIR, DWOO_CACHE_DIR);
        $dwoo->addPlugin('CustomFunctionPlugin', 'custom_plugin');
        $tpl = new Dwoo\Template\String('{$foo=4}{$foo|CustomFunctionPlugin:5}');
        $tpl->forceCompilation();
    ...
    public function testCustomCompilableClassPlugin()
    {
        ...
        $tpl = new Dwoo\Template\String('{CustomCompilableClassPlugin 4 5}');
        $tpl->forceCompilation();
    ...
    public function testCustomCompilableClassPluginAsModifier()
    {
        $dwoo = new Dwoo\Core(DWOO_COMPILE_DIR, DWOO_CACHE_DIR);
        $dwoo->addPlugin('CustomCompilableClassPlugin', array('custom_compilable_class_plugin', 'call'), true);
        $tpl = new Dwoo\Template\String('{$foo=4}{$foo|CustomCompilableClassPlugin:5}');
        $tpl->forceCompilation();
    ...
    public function testCustomClassPlugin()
    {
        ...
        $tpl = new Dwoo\Template\String('{CustomClassPlugin 4 5}');
        $tpl->forceCompilation();
    ...
    public function testCustomClassPluginAsModifier()
    {
        $dwoo = new Dwoo\Core(DWOO_COMPILE_DIR, DWOO_CACHE_DIR);
        $dwoo->addPlugin('CustomClassPlugin', array('custom_class_plugin', 'call'));
        $tpl = new Dwoo\Template\String('{$foo=4}{$foo|CustomClassPlugin:5}');
        $tpl->forceCompilation();
