...
class Policy {
	...
	protected $allowedPhpFunctions = array(
		'str_repeat' => true, 'number_format' => true, 'htmlentities' => true, 'htmlspecialchars' => true, 'long2ip' => true, 'strlen' => true, 'list' => true, 'empty' => true, 'count' => true, 'sizeof' => true, 'in_array' => true, 'is_array' => true,
	);
	 ...
	 *
	 * defaults to Policy::CONST_DISALLOW
	 *
	 * @var bool
	 */
	 ...
	 *
	 * note that all the includePath directories you provide to the File class
	 ...
	 *
	 * @param int $level one of the Policy::PHP_* constants
	 */
	 ...
	 *
	 * @return int the current level, one of the Policy::PHP_* constants
	 */
	 ...
	 *
	 * @param bool $level one of the Policy::CONST_* constants
	 */
	 ...
	 *
	 * @return bool the current level, one of the Policy::CONST_* constants
	 */
