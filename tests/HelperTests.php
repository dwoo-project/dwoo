...
class HelperTests extends PHPUnit_Framework_TestCase
{
    ...
    {
        $tpl = new Dwoo\Template\String('{if array(3,foo, "bar",$baz|upper) === $test}true{/if}');
    ...
    {
        $tpl = new Dwoo\Template\String('{if array(hoy=3,5="foo",bar=moo) === $test}true{/if}');
        $tpl->forceCompilation();
    ...
    {
        $tpl = new Dwoo\Template\String('{if array(hoy=3,5=array(
															"foo"
															frack
															18
    ...
    {
        $tpl = new Dwoo\Template\String('{if array(1=2 2=3 1=4) === $test}true{/if}');
        $tpl->forceCompilation();
    ...
    {
        $tpl = new Dwoo\Template\String('{$var="hoy"}{if array($var=>hey) === $test}true{/if}');
        $tpl->forceCompilation();
    ...
    {
        $tpl = new Dwoo\Template\String('{if array(5="foo", 3=moo) === $test}true{/if}');
        $tpl->forceCompilation();
